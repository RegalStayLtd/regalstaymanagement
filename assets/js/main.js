...
(function ($) {
  ...
  $(".tptestimonial-active-two").slick({
    ...
    prevArrow:
      '<button type="button" class="slick-prev"><span><i class="fa-solid fa-angle-up"></i></span></button>',
    nextArrow:
      '<button type="button" class="slick-next"><span><i class="fa-solid fa-angle-down"></i></span></button>',
  ...
  $(".portfolio-4-active").slick({
    ...
    prevArrow:
      '<div class="prv-testi-case"><span><svg xmlns="http://www.w3.org/2000/svg" width="8" height="14" fill="none"viewBox="0 0 8 14"><path fill-rule="evenodd"d="M7.707.293a1 1 0 0 1 0 1.414L2.414 7l5.293 5.293a1 1 0 0 1-1.414 1.414l-6-6a1 1 0 0 1 0-1.414l6-6a1 1 0 0 1 1.414 0z"fill="#9f9fa9"></path></svg></span></div>',
    nextArrow:
      '<div class="next-testi-case"><span><svg xmlns="http://www.w3.org/2000/svg" width="8" height="14" fill="none" viewBox="0 0 8 14"><path fill-rule="evenodd"d="M.293 13.707a1 1 0 0 1 0-1.414L5.586 7 .293 1.707A1 1 0 1 1 1.707.293l6 6a1 1 0 0 1 0 1.414l-6 6a1 1 0 0 1-1.414 0z" fill="#9f9fa9"></path></svg></span></div>',
  });
